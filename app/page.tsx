...
const games = [
  ...
  { id: 'dames', eyebrow: 'Stratégie & réflexion', title: 'Dames Internationales', description: 'Damier 10×10. 20 pions par joueur. Capturez, devenez dame, gagnez la partie.', icon: Crown, tone: 'bronze', players: '2 joueurs', prompts: [] },
] as const
